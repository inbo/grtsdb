...
The goal of `grtsdb` is to create a statially balanced sample based on the 'Generalised Random Tesselation Stratified' strategy.
...
To extract a sample, you'll need to specify the bounding box in projected
coordinates and the size of the grid cells.
